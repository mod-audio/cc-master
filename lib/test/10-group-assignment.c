...
int main(void)
{
    ...
    cc_assignment_t ass_1 = {-1, dev_id, 2, "List1", 0.f, 0.f, list_count-1, 0.f, CC_MODE_INTEGER|CC_MODE_OPTIONS|CC_MODE_GROUP|CC_MODE_REVERSE, list_count, "-",
        list_count, list_items, 3, -1, 0, 0, 0, 0};
    ...
    // actuator_pair_id, assignment_pair_id
    // list_index, enumeration_frame_min, enumeration_frame_max, actuator_page_id
    cc_assignment_t ass_2 = {-1, dev_id, 3, "List1", 0.f, 0.f, list_count-1, 0.f, CC_MODE_INTEGER|CC_MODE_OPTIONS|CC_MODE_GROUP, list_count, "-",
        list_count, list_items, 2, ass_1.id, 0, 0, 0, 0};
    ...
    cc_assignment_key_t key_1 = {ass_1.id, dev_id, ass_2.id};
    cc_assignment_key_t key_2 = {ass_2.id, dev_id, ass_1.id};
    cc_assignment_set_pair_id(&key_1);
